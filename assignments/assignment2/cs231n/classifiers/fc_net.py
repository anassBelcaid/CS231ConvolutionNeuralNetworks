...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
        ...
        ############################################################################
        self.params['W1'] = np.random.normal(loc=0,size=(input_dim, hidden_dim), scale = weight_scale)
        # self.params['b1'] = np.zeros(input_dim)
        self.params['b1']  = np.zeros(hidden_dim)
        self.params['W2'] = np.random.normal(loc=0,size=(hidden_dim,num_classes),scale = weight_scale)
    ...
    def loss(self, X, y=None):
        ...
        h_layer,h_cache = affine_relu_forward(X,self.params['W1'],self.params['b1'])

        #second layer
        scores, o_cache = affine_forward(h_layer,
        ...
        #computing the grad
        dH,grads['W2'],grads['b2']= affine_backward(dx,o_cache)
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        self.params['W%d'%k] = np.random.normal(loc = 0,
                size=(hidden_dims[-1],num_classes), scale= weight_scale)
        self.params['b%d'%k] = np.zeros(num_classes)



        #printing the keys with size
        # for key  in self.params:
        #     print("key:",key)
        #     print("shape:", self.params[key].shape)
    ...
    def loss(self, X, y=None):
        ...
        #computing the gradient of the softmax layer
        dout, grads['W%d'%k], grads['b%d'%k] = affine_backward(grad_loss,self.caches[k])
        k-=1
        ...
        #adding the regularisation
        for k in range(1,self.num_layers+1):
            w = self.params['W%d'%k]
            loss += 0.5*self.reg * np.sum(w**2)
            grads['W%d'%k]+= self.reg*w
